...
export default function QuizView() {
  ...
  const generate = async () => {
    ...
    try {
      if (!topic) throw new Error("퀴즈의 단원과 세부단원을 선택해주세요.");
      await api("/quizzes", { method: "POST", body: JSON.stringify({ subject, topic, question_count: 3 }) });
      await load();
    }
